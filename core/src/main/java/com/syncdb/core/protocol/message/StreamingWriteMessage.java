...
public class StreamingWriteMessage extends ProtocolMessage {
    ...
    public StreamingWriteMessage(int seq, List<Record<byte[], byte[]>> records) {
        super(MESSAGE_TYPE.STREAMING_WRITE, seq, serializePayload(records));
